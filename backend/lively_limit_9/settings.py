"""
Django settings for lively_limit_9 project.
...
ROOT_URLCONF = 'lively_limit_9.urls'
...
WSGI_APPLICATION = 'lively_limit_9.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lively_limit_9 API",
    "DESCRIPTION": "API documentation for lively_limit_9 App",
    "VERSION": "v1",
}
